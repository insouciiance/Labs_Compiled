...
namespace Matrix
{
    static class MatrixHelper
    {
        ...
        public static double[,] GenerateSquareMatrix(int n)
        {
        ...
        private static int[] GetOrderedIndexes(double[,] matrix)
        {
        ...
        public static void OrderByMainDiagonal(ref double[,] matrix)
        {
